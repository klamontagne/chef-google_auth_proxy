...
attribute :cookie_https_only, kind_of: Boolean, default: true
attribute :cookie_httponly, kind_of: Boolean, default: true
...
attribute :pass_basic_auth, kind_of: Boolean, default: true
